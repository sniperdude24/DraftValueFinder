...
export const api = {
  ...
  weekly: () => req('/api/weekly'),
  freeAgents: (text, commit) => req('/api/league/free-agents', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ text, commit }) }),
